...
### Import ISO3 list ####
iso3<-read.csv2(file="ISO3.csv")

### Import World Bank Income groups 2023 ####
inc_grp<-read.csv(file="WB_income2023.csv")
...
prev<-read.csv(file="Cause_prevalence.csv")
...
mort<-read.csv(file="Cause_mortality.csv") 
...
hyp<-read.csv2(file="Hypertension_cascade.csv")
...
dat_diab<-read.csv2(file="Diabetes_cascade.csv",sep="\t") ### with income groups
...
iso3_diab<-read.csv2(file="ISO3_diab.csv")
...
HIV_AIDS<-read.csv2(file="HIVAIDS_cascade.csv")
